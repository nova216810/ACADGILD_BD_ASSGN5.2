...
public class PS6Main {
    ...
    Configuration conf = new Configuration();
		...
		job.setJarByClass(PS6Main.class);
		job.setMapperClass(PS6Mapper.class);
		job.setCombinerClass(PS6Reducer.class);
		job.setReducerClass(PS6Reducer.class); 
